 ...
 *
 * <p>This Result try to render Excel file with given template and beans map The code use jxls and
 * poi library to render Excel
 */
  ...
  public void apply(
    ...
    try (InputStream is = new FileInputStream(file)) {
      ...
      throw new UnexpectedException(
          "Failed to generate Excel file from template " + file.getAbsolutePath(), e);
    }
  }
