...
!https://travis-ci.org/codeborne/replay.svg?branch=master!:https://travis-ci.org/codeborne/replay !https://badges.gitter.im/codeborne/replay.svg!:https://gitter.im/codeborne/replay

h2. Introduction

RePlay is a fork of Play1! framework made by Codeborne.

This fork is significantly changed (compared to the original Play 1.5.0).
