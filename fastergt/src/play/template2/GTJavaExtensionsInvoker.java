...
public abstract class GTJavaExtensionsInvoker {
  ...
  private static final Invoker regularArgsWithObjectAsCollectionInvoker =
      new WithObjectAsCollectionInvoker(regularArgsInvoker);
  private static final Invoker withRealArgsAsArrayInvoker =
      new WithRealArgsAsArrayInvoker(regularArgsInvoker);
  private static final Invoker withRealArgsAsArrayAndObjectAsCollectionInvoker =
      new WithRealArgsAsArrayInvoker(regularArgsWithObjectAsCollectionInvoker);
  ...
  static ConcurrentMap<InvocationSignature, InvocationInfo> invocationInfoMap =
  ...
  static class RegularArgsInvoker implements Invoker {
    ...
    @Override
    public WrappedMethod findMethod(
        Class jeClazz, String methodName, Object object, Object[] args) {
  ...
  static class InvokerExecutorMethod implements InvokeExecutor {
    @Override
    public Object doIt(WrappedMethod m, String methodName, Object object, Object[] args)
        throws Exception {
  ...
  static class InvocationInfo {
    ...
    InvocationInfo(
        WrappedMethod method, String methodName, InvokeExecutor invokeExecutor, Invoker invoker) {
      this.method = method;
      this.methodName = methodName;
  ...
  public static Object invoke(Class jeClazz, String methodName, Object object, Object[] args) {
    ...
    try {
      ...
      if (invocationInfo != null) {
        ...
        return invocationInfo.invokeExecutor.doIt(
            invocationInfo.method,
            invocationInfo.methodName,
            object,
            (invoker != null ? invoker.fixArgs(object, args) : args));
      }
      ...
      if (invokerExecutor != null) {
        invocationInfoMap.putIfAbsent(
            invocationSignatur, new InvocationInfo(m, methodName, invokerExecutor, invoker));
        return invokerExecutor.doIt(
            m, methodName, object, (invoker != null ? invoker.fixArgs(object, args) : args));
      } else {
      ...
      throw new RuntimeException(
          "Failed to call method " + jeClazz.getName() + '.' + methodName, e.getCause());
    } catch (Exception e) {
      throw new RuntimeException(
          "Failed to call method " + jeClazz.getName() + '.' + methodName, e);
    }
  }
}
