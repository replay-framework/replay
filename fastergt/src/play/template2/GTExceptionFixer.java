...
public class GTExceptionFixer {
  ...
  protected static class FixedStackTrace {
    ...
    public FixedStackTrace(
        GTTemplateRepo.TemplateInfo errorTI,
        String errorInAppClassName,
        int errorLine,
  ...
  protected FixedStackTrace fixStackTrace(StackTraceElement[] seList) {
    ...
    for (StackTraceElement se : seList) {
      ...
      if (clazz.startsWith(GTPreCompiler.generatedPackageName)) {
        ...
        if (clazz.startsWith("org.codehaus.groovy.")
            || clazz.startsWith("groovy.")
            || clazz.startsWith("sun.reflect.")
  ...
  public GTException fixException(Throwable e) {
    ...
    if (e instanceof GTRuntimeExceptionWithSourceInfo) {
      ...
      newE =
          new GTRuntimeExceptionWithSourceInfo(
              e.getMessage(),
              e,
              fixedStackTrace.errorTI.templateLocation,
              fixedStackTrace.errorLine);
      ...
      newE =
          new GTAppClassException(
              e.getMessage(), e, fixedStackTrace.errorInAppClassName, fixedStackTrace.errorLine);
    } else {
