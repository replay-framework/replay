...
public class GTInternalFastTags extends GTFastTag {
  ...
  public static void tag_get(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer content) {
  ...
  public static void tag_ifErrors(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer content) {
  ...
  public static void tag_ifError(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer content) {
  ...
  public static void tag_include(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer content) {
  ...
  public static void tag_doBody(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer _content) {
  ...
  public static void tag_jsAction(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer _content) {
    template.out.append(
        "function(options) {var pattern = '"
            + args.get("arg").toString().replace("&amp;", "&")
            + "'; for(key in options) { pattern = pattern.replace(':'+key, options[key]); } return pattern }");
  }

  public static void tag_option(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer _content) {
  ...
  public static void tag_errorClass(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer _content) {
    if (args.get("arg") == null) {
      throw new GTTemplateRuntimeException(
          "Please specify the error key when using #{errorClass/}");
    }
  ...
  public static void tag_secureInlineJavaScript(
      GTJavaBase template, Map<String, Object> args, GTContentRenderer content) {
