...
public class GTJavaCompileToClass {
  ...
  public GTJavaCompileToClass(ClassLoader parentClassLoader) {
    ...
    this.settings.put(
        CompilerOptions.OPTION_LocalVariableAttribute, CompilerOptions.DO_NOT_GENERATE);
  ...
  public CompiledClass[] compile(String className, String source) {
          ...
          private NameEnvironmentAnswer findType(final String name) {
            ...
            try {
              ClassFileReader classFileReader =
                  new ClassFileReader(bytes, name.toCharArray(), true);
    ...
    Compiler jdtCompiler =
        new Compiler(nameEnvironment, policy, settings, compilerRequestor, problemFactory) {

          @Override
          protected void handleInternalException(
              Throwable e, CompilationUnitDeclaration ud, CompilationResult result) {}
        };
