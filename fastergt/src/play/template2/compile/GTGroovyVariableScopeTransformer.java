    ...
    static class Trans extends ClassCodeExpressionTransformer {
        ...
        public Expression transform(Expression exp) {
            ...
            if (exp instanceof DeclarationExpression) {
                ...
                BinaryExpression e = new BinaryExpression(((DeclarationExpression) exp).getLeftExpression(), ((DeclarationExpression) exp).getOperation(), ((DeclarationExpression) exp).getRightExpression());
