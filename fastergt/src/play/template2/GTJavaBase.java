...
public abstract class GTJavaBase extends GTRenderingResult {
  ...
  public void internalRenderTemplate(
      Map<String, Object> args, boolean startingNewRendering, GTJavaBase callingTemplate)
      throws GTTemplateNotFoundWithSourceInfo, GTRuntimeException {
  ...
  public void internalRenderTemplate(
      ...
      boolean startingNewRendering,
      GTJavaBase callingTemplate)
      throws GTTemplateNotFoundWithSourceInfo, GTRuntimeException {
   ...
   * convertRawDataToString when converting it to String. Framework should override.
   */
  ...
  public String objectToString(Object o) {
    ...
    if (binding.hasVariable("__inside_script_tag")
        && "true".equals(binding.getVariable("__inside_script_tag"))) {
    ...
    switch (argsList.size()) {
      case 0:
        throw new GTTemplateRuntimeException(
            "It looks like you don't have anything in your Message tag");
      case 1:
        return resolveMessage(assertKeyNonNull(argsList.get(0)), emptyArray);
      default:
        return resolveMessage(assertKeyNonNull(argsList.get(0)), messageArguments(argsList));
    }
  }
  ...
  private Object assertKeyNonNull(Object key) {
    if (key == null) {
      throw new GTTemplateRuntimeException(
          "You are trying to resolve a message with an expression "
  ...
  private Object assertArgNotNull(List<Object> argsList, int index) {
    ...
    if (arg == null) {
      throw new IllegalArgumentException(
          String.format(
              "Argument #%s is null at %s: %s", index, templateLocation.relativePath, argsList));
    }
    return arg;
  }
