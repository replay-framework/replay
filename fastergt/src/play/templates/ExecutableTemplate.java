    ...
    try {
      ...
      try {
        ...
        throw new TemplateNotFoundException(
            String.format("tags/%s.tag", templateName), template, fromLine);
      }
    }
  ...
  static class ActionBridge extends GroovyObjectSupport {
    ...
    public Object getProperty(String property) {
      return new ActionBridge(
          template, controller == null ? property : controller + "." + property, absolute);
    }
      ...
      try {
        ...
        try {
          ...
          Router.ActionDefinition def =
              Router.reverse(action, r, request.format, Response.current().encoding);
          if (absolute) {
