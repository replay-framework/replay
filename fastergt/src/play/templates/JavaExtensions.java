...
public class JavaExtensions {
  ...
  /**
   * Concatenate items of a collection as a string separated with <tt>separator</tt> items
   * toString() method should be implemented to provide a string representation
   *
   * @param items List of items
