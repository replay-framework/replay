...
public class DefInScriptsRemoverTest {
  ...
  public void testIt() {
    ...
    assertThat(r.renderSrc("%{ if(true){def a = 'x3'}; b = 'y3' }%${a}:${b}", args))
        .isEqualTo("x3:y3");

    assertThat(r.renderSrc("%{ String a = 'x4'; b = 'y4' }%${a}:${b}", args)).isEqualTo("x4:y4");
    assertThat(r.renderSrc("%{ if(true){String a = 'x5'}; b = 'y5' }%${a}:${b}", args))
        .isEqualTo("x5:y5");

    assertThat(r.renderSrc("%{ Integer a = 1; b = 'y6' }%${a}:${b}", args)).isEqualTo("1:y6");
    assertThat(r.renderSrc("%{ if(true){Long a = 2}; b = 'y7' }%${a}:${b}", args))
        .isEqualTo("2:y7");
  }
}
