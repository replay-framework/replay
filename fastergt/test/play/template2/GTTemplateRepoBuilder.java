...
public class GTTemplateRepoBuilder {
  ...
  public GTTemplateRepoBuilder withGTJavaExtensionMethodResolver(
      GTJavaExtensionMethodResolver gtJavaExtensionMethodResolver) {
  ...
  private static class SpecialGTTemplateLocationReal extends GTTemplateLocationReal {
    ...
    private SpecialGTTemplateLocationReal(
        String relativePath, URL realFileURL, boolean fakeWindowsNewLines) {
  ...
  public GTTemplateRepo build() {
    ...
    if (this.gtJavaExtensionMethodResolver != null) {
      ...
      GTGroovyPimpTransformer.gtJavaExtensionMethodResolver =
          new GTJavaExtensionMethodResolver() {
            @Override
