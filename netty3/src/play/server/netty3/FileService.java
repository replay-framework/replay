...
public class FileService {
  ...
  public void serve(
    ...
    try {
      ...
      boolean isKeepAlive =
          HttpHeaders.isKeepAlive(nettyRequest)
              && nettyRequest.getProtocolVersion().equals(HTTP_1_1);
  ...
  private void writeFileContent(
    ...
    if (!nettyRequest.getMethod().equals(HttpMethod.HEAD)) {
      ChunkedInput chunkedInput =
          getChunkedInput(file, raf, fileContentType, nettyRequest, nettyResponse);
      if (channel.isOpen()) {
  ...
  private ChunkedInput getChunkedInput(
      String file,
      RandomAccessFile raf,
      String contentType,
      HttpRequest nettyRequest,
