...
public class CookieDataCodec {
   ...
   *
   * <p>We need it to support old Play 1.2.5 session data encoding so that the cookie data doesn't
   * become invalid when applications are upgraded to a newer version of Play
   */
