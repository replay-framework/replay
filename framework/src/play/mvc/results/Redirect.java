...
public class Redirect extends Result {
   ...
   * @param parameters Parameters to be included at the end of the URL as a HTTP GET. This is a map
   *     whose entries are written out as key1=value1&amp;key2=value2 etc..
   */
  ...
  public Redirect(String url, boolean permanent) {
    this.url = url;
    this.flashMessages = emptyMap();
    if (permanent) this.code = Http.StatusCode.MOVED;
  }
