...
public class Mail {
  ...
  /**
   * Through this method you can substitute the current MailSystem. This is especially helpful for
   * testing purposes like using mock libraries.
   *
   * <p>Author: Andreas Simon &lt;a.simon@quagilis.de&gt;
   *
  ...
  public static Session getSession() {
    if (session == null) {
      ...
      props.setProperty(
          "mail.smtp.host", Play.configuration.getProperty("mail.smtp.host", "localhost"));
        ...
        try {
          session =
              Session.getInstance(
                  props,
                  (Authenticator)
                      Class.forName(authenticator).getDeclaredConstructor().newInstance());
        } catch (Exception e) {
