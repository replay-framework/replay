...
public abstract class HttpResponse {
   ...
   *
   * @return The parameters as a Map. Return an empty map if the response is not formed as a query
   *     string.
   */
   ...
   *
   * <p>+ this method can only be called onced because async implementation does not allow it to be
