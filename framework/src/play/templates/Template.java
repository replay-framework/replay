...
public abstract class Template {
   ...
   * The input args-map is constantly being modified, as different templates "communicate" with each
   * other by storing info in the map
   *
   * @param args List of arguments use in render
