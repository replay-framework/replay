 ...
 * </code>
 *
 * <p>Note that body-data can contain another multipart entity. There is limited support for single
...
public class MultipartStream {
  ...
  /**
   * A byte sequence that that follows a delimiter that will be followed by an encapsulation (<code>
   * CRLF</code>).
   */
   ...
   *
   * <p>The boundary token of the nested stream is <code>required</code> to be of the same length as
   ...
   *
   * <p>Headers are returned verbatim to the input stream, including the trailing <code>CRLF</code>
