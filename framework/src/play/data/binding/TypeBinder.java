...
public interface TypeBinder<T> {
     ...
     */
    Object bind(Http.Request request, Session session, String name, Annotation[] annotations, String value, Class actualClass, Type genericType) throws ParseException;
