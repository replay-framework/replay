...
public class UrlEncodedParserTest {
  ...
  public void parsePlainQuerystring() {
    ...
    Map<String, String[]> params =
        parser.parse(new ByteArrayInputStream(request.querystring.getBytes(UTF_8)), UTF_8);
  ...
  public void parseUtf16EncodedQuerystring() {
    ...
    parser.forQueryString = true;
    Map<String, String[]> params =
        parser.parse(new ByteArrayInputStream(request.querystring.getBytes(UTF_16)), UTF_16);
