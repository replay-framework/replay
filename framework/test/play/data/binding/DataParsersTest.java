...
public class DataParsersTest {
  ...
  public void getDataParserDependingOnContentType() {
    assertThat(DataParsers.forContentType("application/x-www-form-urlencoded").getClass())
        .isEqualTo(UrlEncodedParser.class);
    assertThat(DataParsers.forContentType("multipart/form-data").getClass())
        .isEqualTo(ApacheMultipartParser.class);
    assertThat(DataParsers.forContentType("multipart/mixed").getClass())
        .isEqualTo(ApacheMultipartParser.class);
    assertThat(DataParsers.forContentType("application/xml").getClass())
        .isEqualTo(TextParser.class);
    assertThat(DataParsers.forContentType("application/json").getClass())
        .isEqualTo(TextParser.class);
  }
  ...
  public void usesTextDataProviderForAnyContentTypeStartingWithText() {
    ...
    assertThat(DataParsers.forContentType("text/anything else").getClass())
        .isEqualTo(TextParser.class);
  }
