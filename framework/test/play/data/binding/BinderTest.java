...
public class BinderTest {
  ...
  public void verify_and_show_how_unbind_and_bind_work() {
    ...
    assertThat(Binder.bind(request, session, root, "myInt", Integer.class, null, null))
        .isEqualTo(myInt);
  }
  ...
  public void verifyBindingOfStringMaps() {
    ...
    data3 =
        (Data3)
            Binder.bind(
                request, session, rootParamNode, "data3", Data3.class, Data3.class, noAnnotations);
    ...
    lst =
        (List<Data2>)
            Binder.bind(
                ...
                "data2",
                lst.getClass(),
                GenericListProvider.class.getDeclaredField("listOfData2").getGenericType(),
                noAnnotations);
  ...
  public void verify_binding_collections_of_generic_types() {
    ...
    Data3 result =
        (Data3)
            Binder.bind(
                request, session, rootParamNode, "data", Data3.class, Data3.class, noAnnotations);
  ...
  public void test_unbinding_of_collection_of_complex_types() {
    ...
    Object binded =
        Binder.bind(request, session, root, "data", Data4.class, Data4.class, noAnnotations);
  ...
  public void test_enum_set_binding() {
    ...
    Data5 bound =
        (Data5)
            Binder.bind(
                request, session, rootParamNode, "data", Data5.class, Data5.class, noAnnotations);
  ...
  public void test_binding_class_with_private_constructor() {
    ...
    Data6 bound =
        (Data6)
            Binder.bind(
                request, session, rootParamNode, "user", Data6.class, Data6.class, noAnnotations);
  ...
  public void verify_binding_of_BigInteger() {
    ...
    Map<String, String[]> r2 = fromUnbindMap2BindMap(r);
    RootParamNode root = ParamNode.convert(r2);
    assertThat(Binder.bind(request, session, root, "myBigInt", BigInteger.class, null, null))
        .isEqualTo(myBigInt);
  }
}
