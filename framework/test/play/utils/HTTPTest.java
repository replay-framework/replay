...
public class HTTPTest {
  ...
  public void testQuotedCharsetInHttpHeader() {
    ...
    HTTP.ContentTypeWithEncoding standardContentType =
        HTTP.parseContentType("text/html; charset=utf-8");
    assertThat(standardContentType.encoding).isEqualTo(UTF_8);
    assertThat(standardContentType.contentType).isEqualTo("text/html");

    HTTP.ContentTypeWithEncoding doubleQuotedCharsetContentType =
        HTTP.parseContentType("text/html; charset=\"utf-8\"");
    ...
    HTTP.ContentTypeWithEncoding simpleQuotedCharsetContentType =
        HTTP.parseContentType("text/html; charset='utf-8'");
