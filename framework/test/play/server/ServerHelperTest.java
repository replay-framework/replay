...
public class ServerHelperTest {
  ...
  public void isKeepAlive_http_1_0() {
    ...
    assertThat(helper.isKeepAlive("HTTP/1.0", "")).as("By default keep-alive not enabled").isFalse();
  }
  ...
  public void getContentTypeValue() {
    assertThat(helper.getContentTypeValue(response("", UTF_8))).isEqualTo("text/plain; charset=UTF-8");
    assertThat(helper.getContentTypeValue(response("text/plain", UTF_8))).isEqualTo("text/plain; charset=UTF-8");
    assertThat(helper.getContentTypeValue(response("text/plain", UTF_16))).isEqualTo("text/plain; charset=UTF-16");
    assertThat(helper.getContentTypeValue(response("text/plain; charset=UTF-128", UTF_8))).isEqualTo("text/plain; charset=UTF-128");
    assertThat(helper.getContentTypeValue(response("application/excel", UTF_8))).isEqualTo("application/excel");
  }
