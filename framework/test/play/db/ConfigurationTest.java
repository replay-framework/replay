...
public class ConfigurationTest {
  ...
  public void dbNameResolver_multipleDatabases() {
    ...
    assertThat(new Configuration("default").getProperty("db")).isEqualTo(
        "mysql:user:pwd@database_name");
    assertThat(new Configuration("test").getProperty("db")).isEqualTo(
        "mysql:user:pwd@database_name2");
  }
  ...
  public void dbNameResolverMultiDbURL_multipleDatabases() {
    ...
    assertThat(configuration1.getProperty("db.url")).isEqualTo(
    ...
    assertThat(configuration2.getProperty("db.url")).isEqualTo(
        "jdbc:postgresql://localhost/database_name2");
  ...
  public void putPropertyToMultipleCustomConfigurations() {
    ...
    assertThat(Play.configuration.getProperty("db.default.driver")).isEqualTo(
  ...
  public void getPropertyFromDefaultConfiguration() {
    Play.configuration.setProperty("db.default.url",
        "jdbc:h2:mem:play;MODE=MSSQLServer;LOCK_MODE=0");
    Configuration configuration = new Configuration("default");
    assertThat(configuration.getProperty("db.url")).isEqualTo(
        "jdbc:h2:mem:play;MODE=MSSQLServer;LOCK_MODE=0");
  }
}
