...
```groovy
dependencies {
  implementation("io.github.replay-framework:framework:2.8.2")
  implementation("io.github.replay-framework:javanet:2.8.2") // you can replace "javanet" by "netty3" or "netty4"
  
  // Optionally:
  implementation("io.github.replay-framework:guice:2.8.2")
  implementation("io.github.replay-framework:fastergt:2.8.2")
  implementation("io.github.replay-framework:liquibase:2.8.2")
  implementation("io.github.replay-framework:pdf:2.8.2")
  implementation("io.github.replay-framework:excel:2.8.2")
  implementation("io.github.replay-framework:ehcache:2.8.2") // or `memcached`, or disable caching by not specifying a caching package. Earlier `memcached=true` setting won't be checked anymore!
}
```
